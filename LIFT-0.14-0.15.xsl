...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- defining vern-lang-nodes and anal-lang-nodes is SLOW for large files, but I don't know of a a better way to get the information. -->
	...
	<xsl:variable name="anal-lang" select="/lift/entry/sense/definition/form[1]/@lang"/>
	<xsl:variable name="anal-lang-nodes" select="/lift/entry/sense/definition/form[not(@lang=preceding::definition/form/@lang)]/@lang"/>
